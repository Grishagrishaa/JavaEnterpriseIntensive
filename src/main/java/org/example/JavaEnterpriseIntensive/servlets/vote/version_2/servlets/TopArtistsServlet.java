...
@WebServlet(name = "TopArtistsServlet", urlPatterns = "/topArtists")
public class TopArtistsServlet extends HttpServlet {

    VoteService vService = VoteService.getInstance();
    Map<String, Integer> topArtists = vService.getTopArtists();
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        List list = new ArrayList(topArtists.entrySet());
